...
import { QlContactComponent } from './pages/ql-contact/ql-contact.component';
import { QlProductComponent } from './pages/ql-product/ql-product.component';
import { QlReviewComponent } from './pages/ql-review/ql-review.component';
