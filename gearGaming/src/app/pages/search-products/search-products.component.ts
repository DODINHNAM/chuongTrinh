...
export class SearchProductsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.searchProduct(this.pageIndex, this.pageSize, 'productPrice', 'descend');
  }
  ...
  searchProduct(
    ...
    sortOrder: string | null
      ...
      this.controlArray.set('key', this.key);
      ...
      console.log(this.controlArray)
        // get product
        this.productService.searchProducts(this.controlArray).subscribe(
          (data) => {
  ...
  changeStatus(e) {
    if(e){
      ...
      if(e=="p-asc"){
        this.searchProduct(this.pageIndex, this.pageSize, 'productPrice', 'ascend');
      }
      if(e=="default"){
        this.searchProduct(this.pageIndex, this.pageSize, 'productID', 'descend');
      }
    }
  }
